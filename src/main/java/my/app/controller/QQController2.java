...
//                    System.out.println("图片：" + imgUrl);
                    ...
                    FileStore store = tmpFileService.store;
...
//                    http.close();
                    ...
                    // 头像的正式URL
                    String url = thumbService.usePhoto(request, user, store.getFile(photoName));
//                    //暂不启用
//                    map.put("qq", "qq" + id);
                    ...
                    userLoginService.login(session, user, userAbility);
                    return "forward:/message/list";
                }
                else
                {
