 ...
 */
@Controller
public class mesImaUrlService
{
	@GetMapping("/bbsfile/message/**")
...
//		System.out.println("image");
		...
		//取得文件名
		String prefix = "/bbsfile/message/";
		int p = requestUri.indexOf(prefix);
		String filePath = requestUri.substring(p + prefix.length());
		
		
		//目标文件
//		File targetFile = mesImaStore.getFile(filePath);
		File targetFile = MessageController.store.getFile(filePath);
